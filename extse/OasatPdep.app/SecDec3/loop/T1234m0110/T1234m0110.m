...
proplist={k1^2,(k1+p1)^2-ms[1],(k2-k1)^2-ms[1],k2^2};
numerator={1};
...
(*checked: threshold corresponds to 
 ...
 (Sqrt[ms[1]]+Sqrt[ms[1]])^2 while 
 2-particle cut is (Sqrt[ms[1]])^2*)
...
graphstring="T1234m0110";

currentdir="/home/pcl335a/sborowka/Work/OasatPdep/SecDec3/loop/T1234m0110/"
