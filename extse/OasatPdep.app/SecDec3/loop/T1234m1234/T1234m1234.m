...
(*checked: threshold chosen according to
 which particle cut is smaller:
 2-particle cut: (Sqrt[ms[1]]+Sqrt[ms[2]])^2
 3-particle cut: (Sqrt[ms[2]]+Sqrt[ms[3]]+Sqrt[ms[4]])^2
 to smallest mass configuration: mt^2+mgl^2+mst1^2,
 instead of 2*(ms[1]+ms[2]) *)
...
graphstring="T1234m1234";

currentdir="/home/pcl335a/sborowka/Work/OasatPdep/SecDec3/loop/T1234m1234/"
