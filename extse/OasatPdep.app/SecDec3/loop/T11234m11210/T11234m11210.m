...
proplist={k1^2-ms[1],(k1+p1)^2-ms[2],(k2-k1)^2-ms[1],k2^2};
numerator={1};
...
(*checked: threshold comes from 2-particle cut and 3-particle cut. 
 Both lead to the same result in this topology because
 the mass of the last propagator which would correspond
 to ms[4] vanishes:
 (Sqrt[ms[1]]+Sqrt[ms[2]])^2 *)

threshold = ssp[1]>=(Sqrt[ms[1]]+Sqrt[ms[2]])^2;
cutconstruct=False;
...
graphstring="T11234m11210";

currentdir="/home/pcl335a/sborowka/Work/OasatPdep/SecDec3/loop/T11234m11210/"
