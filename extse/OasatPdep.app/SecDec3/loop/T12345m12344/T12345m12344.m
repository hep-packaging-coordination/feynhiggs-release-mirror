...
momlist={k1,k2};
proplist={k1^2-ms[1],(k1+p1)^2-ms[2],(k2-k1)^2-ms[3],k2^2-ms[4],(k2+p1)^2-ms[4]};
numerator={1};
...
(*checked: lowest threshold belongs to any of the
 2-particle cuts. The 3-particle cut contributes to
 the imaginary part only, therefore it is neglected
 in the choice of threshold *)

threshold = ssp[1]>=Min[(Sqrt[ms[1]]+Sqrt[ms[2]])^2,(Sqrt[ms[1]]+Sqrt[ms[3]]+Sqrt[ms[4]])^2,(Sqrt[ms[2]]+Sqrt[ms[3]]+Sqrt[ms[4]])^2,4*ms[4]];
cutconstruct=False;
...
graphstring="T12345m12344";

currentdir="/home/pcl335a/sborowka/Work/OasatPdep/SecDec3/loop/T12345m12344/"
