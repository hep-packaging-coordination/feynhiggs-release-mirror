...
proplist={k1^2,(k1+p1)^2-ms[1],(k2-k1)^2-ms[2],k2^2-ms[3]};
numerator={1};
...
(*checked: threshold corresponds to 
 ...
 (Sqrt[ms[1]]+Sqrt[ms[2]]+Sqrt[ms[3]])^2 while 
 2-particle cut is (0+Sqrt[ms[1]])^2*)

threshold = ssp[1]>=ms[1];
cutconstruct=False;
...
graphstring="T1234m0123";

currentdir="/home/pcl335a/sborowka/Work/OasatPdep/SecDec3/loop/T1234m0123/"
