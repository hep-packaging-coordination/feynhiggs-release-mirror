...
momlist={k1,k2};
proplist={k1^2-ms[1],(k1+p1)^2-ms[2],(k2-k1)^2,k2^2-ms[1],(k2+p1)^2-ms[2]};
numerator={1};
...
(*checked: Threshold depends on 
 size of masses, either ms[1] is smaller or ms[2]. 
 Accordingly, twice the smallest mass is chosen,
 (2*Sqrt[ms[smallest]])^2
 with vanishing mass in propagator 3 *)

threshold = ssp[1]>=4*Min[ms[1],ms[2]];
cutconstruct=False;
...
graphstring="T12345m12012";

currentdir="/home/pcl335a/sborowka/Work/OasatPdep/SecDec3/loop/T12345m12012/"
